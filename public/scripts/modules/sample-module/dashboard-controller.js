define(['angular', './sample-module'], function(angular, controllers) {
  ...
  controllers.controller('DashboardsCtrl', ['$scope', '$log', 'PredixAssetService',
    'PredixViewService',
    function($scope, $log, PredixAssetService, PredixViewService) {

      PredixAssetService.getAssetsByParentId('root')
      ...
      $scope.openContext = function(contextDetails) {
        ...
        // gets all decks for this context
        PredixViewService.getDecksByTags(newContext.classification)
          .then(function(decks) {
            $scope.decks = [];
